...
\begin{tabular}{L{3.5cm} L{2cm} L{9cm}}
\toprule
\textbf{Component} & \textbf{Symbol} & \textbf{Strategic Function} \\
\midrule
Stability Bonus & $B_{stab}$ & Rewards sustaining context-appropriate actions. \\
Ramp Bonus & $B_{ramp}$ & Incentivizes transition from Redirect to Block. \\
Persistence Bonus & $B_{persist}$ & Rewards sustained Block actions. \\
Oscillation Penalty & $P_{osc}$ & Penalizes downgrading defense levels during attacks. \\
Premature Penalty & $P_{premature}$ & Penalizes Block execution before sufficient evidence. \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Recursive URL \& Base64 Decoding:} Dismantles multi-level encoding.
...
\begin{table}[htbp]
\centering
\caption{Inventory of 20 Traffic and Payload Features (F1-F20)}
\label{tab:f1_f20_inventory}
\begin{tabular}{L{1cm} L{3.5cm} L{5cm} C{1.5cm} L{3.5cm}}
\toprule
...
\label{tab:f21_f30}
\begin{tabular}{L{1.5cm} L{3cm} L{9cm}}
\toprule
