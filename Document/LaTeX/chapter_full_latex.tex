...
\bibitem{p1} Puterman, M. L. (1994). Markov Decision Processes. Wiley.
\bibitem{p2} Schulman, J., et al. (2017). Proximal Policy Optimization. arXiv:1707.06347.
\bibitem{p3} Raffin, A., et al. (2021). Stable-Baselines3. JMLR, 22(268).
\bibitem{p4} Sharafaldin, I., et al. (2018). IDS Dataset Generation. ICISSP.
\bibitem{p5} OWASP. (2023). ModSecurity CRS v4.0.
\bibitem{p6-20} [Additional 15 references...]
\end{thebibliography}
