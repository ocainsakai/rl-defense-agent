...
ATTACK_DAYS = [
    {
        "day":        "FP-Test-UCAP172.31.69.27",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.27",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.25",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.25",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.22",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.22",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.18",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.18",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.21",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.21",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.15",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.15",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    ...
    {
        "day":        "FP-Test-UCAP172.31.69.7",
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.7",
        "pcap_large": False,
        "attackers":  [],
        "windows":    [],
        "benign_cap": 5000,
    },
    {
        ...
        "pcap":       "/mnt/hgfs/pcap data/CICIDS2018/pcap/pcap/UCAP172.31.69.28",
        "pcap_large": False,
        "attackers":  ["18.218.115.60"],
        "windows": [
            (_ast("2018-02-23 10:03:00"), _ast("2018-02-23 11:03:00"),
             "brute_force", "Redirect", "Brute Force-Web"),
            (_ast("2018-02-23 13:00:00"), _ast("2018-02-23 14:10:00"),
             "xss",         "Redirect", "Brute Force-XSS"),
            (_ast("2018-02-23 15:05:00"), _ast("2018-02-23 15:18:00"),
...
def create_filtered_pcap(src_pcap: str, dst_pcap: str, attacker_ips: List[str],
    ...
    # tshark may be SIGKILL'd after writing output (OOM / stats flush) — check file size
    dst = Path(dst_pcap)
    if not dst.exists() or dst.stat().st_size < 24:
